...
ax.plot(cycles, 1/(2 * signal_to_noises[0]) * 1/cycles, 'b--')
ax.plot(cycles, 1/(2 * signal_to_noises[1]) * 1/cycles, 'r--')
...
for snr in signal_to_noises:
    ...
    for samples_per_cycle in tqdm(np.arange(2, 100, 2), leave = True, position = 0):
